...
- (instancetype)init {
    ...
    if (self) {
        ...
        NSArray *attackNames = [NSArray arrayWithObjects:@"Pan Throw", @"Head Butt", @"Sear", @"Infection", nil];
        ...
        NSArray *infection = [NSArray arrayWithObjects:@"KIP'S INFECTION KILLED HIM!", @"KIP'S INFECTION MIGHT SPREAD TO YOU!", @"KIP'S INFECTION DIDN'T HOLD", nil];
